...
| 로보틱스 리드 | Rémi Cadène (Principal Research Scientist) |
...
| 해커톤 | 내용 |
|--------|------|
| 2024.10 | 첫 커뮤니티 해커톤 (툴루즈, 프랑스) |
| 2025.06 | 월드와이드 해커톤 (전 세계 동시 개최) |
| 결과물 | 다양한 환경의 데이터셋 공유 |
