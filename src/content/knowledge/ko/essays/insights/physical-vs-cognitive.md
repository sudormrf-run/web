...
MIT 기계공학과 교수이자 Biomimetic Robotics Lab의 디렉터인 김상배 교수는 TEDxMIT 강연에서 흥미로운 실험을 공유합니다. 카메라로 자신의 손이 과일(배)을 집는 과정을 촬영했는데, 전체 과정이 약 0.7초밖에 걸리지 않았습니다.

슬로우 모션으로 분석하자, 그 짧은 시간 동안 **5~6번의 의사결정**이 일어났습니다:

1. 처음 배를 잡으려고 시도
2. 잡는 데 실패
3. 실패하면서 손이 5개의 다른 배에 접촉
4. 그중 하나를 선택 (의외로 가장 아래에 있는 배)
5. 성공적으로 잡아 올림

이 과정 중 어떤 것도 의식적으로 기억하지 못했습니다. 배를 보지도 않았고, 손가락 관절의 궤적을 계획하지도 않았습니다. 완전히 무의식적으로, 자동적으로 일어난 일이었습니다.

---

## 혀가 하는 일

김상배 교수는 또 다른 예시를 들었습니다.
