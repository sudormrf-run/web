...
2024년 9월 30일 출시된 2세대 휴머노이드. 손 민첩성과 배터리 수명이 대폭 향상되었다.
...
**주요 특징**:
- **Full-Perception 멀티모달 상호작용 시스템**: 시각, 청각, 촉각 센싱 통합
- **31개 압력 센서**: 전신 터치 감지 및 반응 가능
- **4-mic 어레이**: 에코 캔슬링, 전방향 웨이크 및 빔포밍
- **RGB + 구조광 모듈**: 얼굴 인식 및 동적 추적
- **Morandi 톤 팔레트**: 따뜻한 색상으로 기계적 느낌 완화
...
- **오픈소스**: Fourier N1 (2025년 4월 11일 출시)은 중국 최초의 검증된 오픈소스 휴머노이드 ([Wikipedia](https://en.wikipedia.org/wiki/Fourier_(company)))
  - 높이 1.3m, 무게 38kg, 23 DoF
  - 최대 속도 3.5 m/s, 연속 동작 2시간 이상
  - FSA 2.0 액추에이터 탑재, 1,000시간 이상의 야외 테스트 검증
  - GitHub에서 BOM, 설계 도면, 조립 가이드, 소프트웨어 코드 공개
...
| 촉각 센서 | X | O (6개 어레이) | O (31개 압력 센서) |
| 배터리 | 기본 | 2배 용량, 탈착식 | 약 3시간, 핫스왑 |
