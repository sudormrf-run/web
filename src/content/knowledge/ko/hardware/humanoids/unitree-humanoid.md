...
- **2023**: H1 휴머노이드 공개 (World Robotics 2023, 8월)
- **2024**: G1 공개 (5월) 및 양산 시작 (8월)
- **2025**: R1 엔트리급 휴머노이드 발표 (7월), H2 차세대 모델 공개
- **2026**: R1 정식 출하 시작 (1월~)
...
|-----------|------|--------------|--------|
| Boston Dynamics Atlas | 비매품 (연구용) | H1 (~$90,000) | - |
| Figure 01 | $30,000-$150,000 (추정) | G1 ($13,500~) | ~55-91% |
| Tesla Optimus | $20,000-$30,000 (예정) | R1 ($5,900~) | ~70-80% |

**연구 커뮤니티에 미친 영향:**
1. **대학 연구실 접근성**: $13,500 G1은 대부분의 대학 연구실 예산으로 구매 가능
...
|------|------|------|------|----------|-----------|------|
| **R1** | $5,900~ | 122cm | 25kg | 26 | - | 교육, 입문 |
| **R1 EDU** | ~$16,000 | 122cm | 25kg | 26 | - | 연구, 개발 |
| **G1 Basic** | $13,500~ | 127cm | 35kg | 23 | 2 m/s | 소비자, 입문 |
| **G1 EDU Standard** | $43,500~ | 127cm | 35kg | 23 | 2 m/s | 연구, 개발 |
| **G1 EDU Plus** | $52,000~ | 127cm | 35kg | 29 | 2 m/s | 연구, 개발 |
| **G1 EDU Ultimate** | $64,000-$74,000 | 127cm | 35kg | 23 | 2 m/s | 연구, 개발 |
| **H1** | ~$90,000 | 180cm | 47kg | 19 | 3.3 m/s | 고급 연구 |
| **H1-2** | ~$129,000 | 178cm | 70kg | 27 | 1.5-5 m/s | 산업, 연구 |
| **H2** | $29,900~ | 182cm | 70kg | 31 | - | 산업, 상용화 |
...
|------|-----|--------|
| **가격** | $5,900~ | ~$16,000 |
| **DoF** | 26 (다리 6x2, 팔 5x2, 허리 2, 머리 2) | 26 |
| **크기** | 1220 x 357 x 190 mm | 동일 |
| **무게** | ~25 kg | ~25 kg |
| **컴퓨팅** | 8코어 CPU | NVIDIA Jetson Orin |
| **센서** | 스테레오 카메라, 4-마이크 어레이 | 동일 |
| **통신** | Wi-Fi 6, Bluetooth 5.2 | 동일 |
| **배터리** | ~1시간 (퀵스왑) | 동일 |
| **출시** | 2025년 7월 발표, 2026년 1월 출하 | 2025년 7월 발표, 2026년 1월 출하 |

**특징:**
- 2025년 7월 공개, $5,900 가격으로 가장 저렴한 풀사이즈 휴머노이드
...
**R1 EDU 변형 (손 포함):**
- **R1 EDU U3**: Dex3-1 3핑거 손 (손 1개당 ~$5,200)
- **R1 EDU U5**: Revo 2 Basic 5핑거 손
...
|------|----------|-----------------|-------------|-----------------|
| **가격** | $13,500~ | $43,500~ | $52,000~ | $64,000-$74,000 |
| **본체 DoF** | 23 | 23 | 29 | 23 |
...
**H1 시리즈 특징:**
- 2024년 3월 휴머노이드 보행 속도 기네스 기록 보유 (3.3 m/s, H1 V3.0 Evolution) [^3]
- 세계 최초 전기 구동 휴머노이드 제자리 백플립 성공
...
- 턴키 솔루션 지향
- 기업 고객용 정의된 유스케이스
- H2 Commercial (단일 프로세서) vs H2 EDU (듀얼 프로세서, 2차 개발 지원)
- 예상 출하: 2026년 4월~
...
| 제조사 | 모델 | 가격 | 본체 DoF | 특징 |
|--------|------|------|----------|------|
| **Unitree** | G1 | $13,500~ | 23-29 | 가성비, 연구 접근성 |
| **Unitree** | H1 | ~$90,000 | 19-27 | 속도 기록 보유 |
...
- [Unitree 쿼드러펫](/knowledge/hardware/quadrupeds/unitree)
- [GR00T 모델](/knowledge/models/groot)
- [Figure 휴머노이드](figure)
