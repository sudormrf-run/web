...
| 본사    | 노르웨이 Moss (2025년 7월 미국 Palo Alto로 이전) | [3][4] |
| 높이    | 약 167-168cm (5'6")                 | [1][5] |
| 무게    | 약 30kg (66 lbs)                    | [1]    |
| 들기 용량 | 70kg (154 lbs) (발표 기준)             | [1]    |
| 운반 용량 | 약 25kg (55 lbs)                    | [1]    |
| 손 자유도 | 22 DOF (총 75 DOF 발표)               | [1]    |
| 이동 속도 | 보행 1.4m/s (~5km/h), 최대 6.2m/s (~22km/h) | [1]    |
...
| 버전 | 공개 시기 | 주요 특징 | 출처 |
|------|----------|----------|------|
| **NEO Beta** | 2024년 8월 30일 | 초기 프로토타입, 기본 이족 보행 시연, 보행 4km/h, 최대 12km/h | [5] |
| **NEO Gamma** | 2025년 2월 21일 | 향상된 손재주, 세련된 디자인, 제조성 및 신뢰성 개선 | [5] |
| **NEO (Consumer)** | 2025년 10월 28일 | 소비자용 버전 사전 예약 시작, 2026년 미국 배송 예정, 2027년 글로벌 확대 | [6] |
...
| 구성 요소 | 설명 |
|----------|------|
| 모델 크기 | Transformer 기반, 160M 파라미터 |
| 실행 환경 | NEO 온보드 GPU (NVIDIA Jetson Thor 기반) |
| 실행 속도 | 약 5Hz (클라우드 연결 없이 로컬 실행) |
...
| 본사 | 노르웨이 Moss에서 설립, 2025년 7월 미국 Palo Alto로 이전 |
