...
| 설립 | 1987년 | [^1] |
| 상용화 | 2004년경 (프로토타입에서 제품화 전환) | [^2] |
| DoF | 20개 자유도, 24개 움직임 | [^3] |
| 모터 | 20개 | [^3] |
| 센서 | 100개 이상 (최대 1kHz 샘플링) | [^3] |
...
- **오랜 활용 실적**: 2004년경 상용화 이후 NASA, OpenAI, Google DeepMind, Carnegie Mellon 등 주요 연구 기관에서 채택 [^2]
...
**센서 아키텍처**
- 100개 이상의 센서가 인간 손의 고유수용감각(proprioception)과 촉각을 모방 [^3]
...
**BioTac 센서 상세** [^7]
- 19개 임피던스 감지 전극 (BioTac 클래식) 또는 24개 (BioTac SP)
- 100Hz 샘플링
- 유체 압력(pdc), 진동(pac), 온도(tdc/tac) 감지
...
| 항목 | 내용 | 출처 |
|------|------|------|
| 설립 | 1987년 (Richard Greenhill, 런던 자택 다락방에서 취미 그룹으로 시작) | [^1] |
| 정식 등록 | 1997년 1월 27일 (로봇 다리 컴포넌트 의뢰 계기) | [^2] |
| 본사 | 영국 런던 | [^1] |
| 지사 | Bristol, Madrid | [^1] |
| 특징 | 영국에서 가장 오래 운영 중인 로봇 회사 | [^1] |
