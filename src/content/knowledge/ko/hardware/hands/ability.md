...
| 항목 | 스펙 |
|------|------|
| 제조사 | PSYONIC (본사: 샌디에이고, 캘리포니아; 2022년 일리노이주 샴페인에서 이전) |
| 설립자 | Aadeel Akhtar, PhD (신경과학 박사, 전기/컴퓨터공학 석사 - UIUC) |
| 설립년도 | 2015년 (일리노이 대학교 어바나-샴페인에서 창업) |
| 무게 | 약 490g (성인 평균 손 무게보다 약 20% 가벼움) |
| 파지력 | 66N (14.8 lbs) |
| 최대 축방향 들어올림 하중 | 권장 50 lbs, 최대 79 lbs |
| 손가락 폐쇄 시간 | 0.2초 (200ms, 경쟁사 대비 2배 이상 빠름) |
| 배터리 | 7.4V 2200mAh LiPo, 사용 패턴에 따라 6-8시간 지속 |
| 충전 | USB-C, 약 1시간 완충 |
| 방수등급 | IP64 (먼지 완전 차단, 물 튀김 보호 - 수중 침수 불가) |
| 그립 패턴 | 32개 (19개 사전 정의, 추가 커스터마이징 가능) |
| 구조 | 카본 파이버 케이스 + 6개 브러시리스 DC 모터 |
| 소비자 가격 | $15,500 (제조 원가 약 $1,800) |
...
2014년 여름, Akhtar는 대학원생 시절 Range of Motion Project(ROMP)와 함께 에콰도르 키토로 가서 첫 3D 프린팅 의수 프로토타입 테스트를 진행했다. 약 35년 전 에콰도르-페루 전쟁에서 손을 잃은 Juan Suquillo에게 의수를 착용시켰을 때, 그는 처음으로 엄지와 검지를 집을 수 있었고 "나의 일부가 돌아왔다"고 말했다.
...
| 소비자 가격 | $15,500 |
| 제조 원가 | 약 $1,800 |
| 보험 적용 후 예상 | $10,000 - $20,000 (보험 조건에 따라 상이) |
...
- **Valkyrie 휴머노이드 로봇**: 우주 임무 관련 조작 연구(예: ISS와 유사한 콘솔/패널 조작)
...
- **Apollo 휴머노이드 로봇**: 2023년 IEEE Robotics and Automation 컨퍼런스에서 Ability Hand 통합 시연; 2023년 11월 Apollo 공식 출시
- Apollo 사양: 높이 1.7m (5'9"), 무게 73kg (160lbs), 25kg(55lbs) 리프팅 가능, 스왑 가능한 배터리로 약 4시간 작동
- 휴머노이드 로봇 양산 라인에서 Ability Hand 활용 가능성 탐구
- Apptronik 연혁: UT Austin Human Centered Robotics Lab에서 NASA DARPA Robotics Challenge 협력 후 설립

### 연구용 제품 출시

PSYONIC은 전 세계 로보틱스 연구자들을 위해 Ability Hand를 연구용으로 별도 출시하였다. [^5]

- **Open API**: 전체 시스템 통합 가능 (BLE, I2C, UART, RS485 통신 프로토콜)
- **빠른 속도**: 200ms 폐쇄 시간
- **멀티터치**: 30개 터치 센서 값 스트리밍, 촉각 피드백 연구에 적합
- **내구성**: 연구 환경의 반복 테스트에 적합
- **연구 기관**: Georgia Tech, UIUC, Northwestern, ETH Zurich, Shirley Ryan Ability Lab 등에서 활용 중
...
- **원래 요청**: $1,000,000 (2% 지분, 기업가치 $50M 기준)
- **최종 투자금**: $1,000,000 (6% 지분)
- **투자자**: Lori Greiner, Daymond John, Kevin O'Leary (3인 공동 투자)
- **기업가치 구조**: 보통주와 어드바이저리 주식의 조합으로 기업가치 $50M 설정 [^6]
- **2024년 6월 기준 기업가치**: 약 $65M

### 성장 현황 (2024년 기준)

- **직원**: 약 20-37명 (엔지니어, 의사, 사회복지사, 공중보건 전문가)
- **시설**: 샌디에이고 22,000 sq.ft. (이전 시설 대비 5배 규모로 확장)
- **생산량**: 연 500대 (2024년 기준, 기존 100대에서 증가; 연 1,000대 목표)
- **펀딩**: 2024년 1월 $4.1M 에쿼티 크라우드펀딩 (StartEngine)
...
*이 문서의 정보는 2025년 1월 기준으로 작성되었으며, 2026년 1월에 팩트체크 및 업데이트되었습니다. 최신 정보는 공식 웹사이트를 참조하세요.*
