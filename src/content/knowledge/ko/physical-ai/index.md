...
### 인사이트 에세이
- [VLA & RFM 발전 과정](/knowledge/physical-ai/essays/insights/vla-rfm-progress) - VLA와 RFM의 진행 중인 발전
- [Teleoperation](/knowledge/physical-ai/essays/insights/teleoperation) - 사람이 로봇을 조종하며 데이터 수집
- [Non-Teleop 데이터](/knowledge/physical-ai/essays/insights/non-teleop-data) - 다른 방식의 데이터 수집
- [시뮬레이션 & World Model](/knowledge/physical-ai/essays/insights/simulation-world-model) - 가상 환경 활용
- [휴머노이드 디자인](/knowledge/physical-ai/essays/insights/humanoid-design) - 왜 휴머노이드인가?
- [촉각 센싱](/knowledge/physical-ai/essays/insights/tactile-sensing) - 시각만으로는 부족하다
- [Physical vs Cognitive AI](/knowledge/physical-ai/essays/insights/physical-vs-cognitive) - 지능의 두 측면
- [커뮤니티 접근](/knowledge/physical-ai/essays/insights/community-driven) - 오픈소스 생태계
