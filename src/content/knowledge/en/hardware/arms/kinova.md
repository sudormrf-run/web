...
Kinova is a service robotics company co-founded in 2006 in Boisbriand, Quebec, Canada by Charles Deguire and Louis-Joseph L'Ecuyer, originally starting with the development of assistive robot arms for people with upper body disabilities. The company was founded when co-founder Charles Deguire was inspired by the robot arm that his uncle Jacques Forest (nicknamed "Jaco"), who was living in a wheelchair due to muscular dystrophy, had built in the 1980s using windshield wiper motors, bicycle wires, and lamp parts. Jacques passed away in 1993, but the first product 'Jaco' was named after his nickname. ([Wikipedia](https://en.wikipedia.org/wiki/Kinova), [IEEE Spectrum](https://spectrum.ieee.org/startup-spotlight-kinova))
...
4. **Integrated Vision System**: Gen3 is a research robot arm with optional 2D/3D vision module, optimized for vision-based robot control
...
*Source: [Gen3 Official Product Page](https://www.kinovarobotics.com/product/gen3-robots), [QVIRO Gen3 Specifications](https://qviro.com/product/kinova/gen3/specifications)*
...
*Source: [Gen3 Lite Official Product Page](https://www.kinovarobotics.com/product/gen3-lite-robots), [QVIRO Gen3 Lite Specifications](https://qviro.com/product/kinova/gen3-lite/specifications)*
...
4. **Vision-based Manipulation**: Vision-based robot control research using optional 2D/3D vision module
