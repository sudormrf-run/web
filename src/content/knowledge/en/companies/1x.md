...
1X Technologies is a Norway-based humanoid robotics startup developing the android robots EVE and NEO. The company differentiates itself through the **[Redwood AI](/knowledge/models/redwood-ai)** model and an automated evaluation/training system using **World Models**.
...
- [Redwood AI](/knowledge/models/redwood-ai) - 1X's VLA Model
