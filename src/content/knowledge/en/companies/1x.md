...
1X Technologies is a Norway-based humanoid robotics startup developing the android robots EVE and NEO. The company differentiates itself through the **[Redwood AI](../models/redwood-ai.md)** model and an automated evaluation/training system using **World Models**.
...
- [Redwood AI](../models/redwood-ai.md) - 1X's VLA Model
